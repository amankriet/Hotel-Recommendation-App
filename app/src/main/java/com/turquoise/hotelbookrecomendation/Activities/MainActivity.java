...
public class MainActivity extends AppCompatActivity implements Serializable {
    ...
    public static List<Hotel> cartList = new ArrayList<>();
    ...
    public static void updateCartCount(int n) {
        ((TextView)toolbar.findViewById(R.id.cartCount)).setText(String.valueOf(n));
    }
